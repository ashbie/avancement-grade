...
<form method="post">
<ul>
    <li><label for="titre_id">Titre</label></br>
    ...
    <li><label for="grade_id">Grade</label></br>
...
<tbody>
    ...
    while( $row = $result->fetch_assoc()){
        ...
        echo "<td>".$comp_row['titre'] . "</td>";
        echo "<td>".$comp_row['grade'] . "</td>";
        echo "<td><p data-placement='top'><button class='btn btn-info btn-sm' type='submit' name='voir_dossier' data-title='voir_dossier' data-toggle='modal' data-target='#voir_dossier' ><i class='as fa-edit'></i></button></p></td>";
        echo "</tr>";
        echo "</form>"; //added
    }
